...
class ThanhDieuHeader implements ThanhDieuConfigInterface {
    ...
    public $keywords = "thanhphat,web thanh phat,le nguyen thanh phat,thanhphattv,wsteam,wusteam,thanhphat home,profile thanhphat";
    public $favicon = "./res/v5/img/logo.jpg";
    public $namesite = "THANHPHAT | HOME";
    public $avatar = "./res/v5/img/avatar.gif";
    public $userName = ["Hello Everybody", "My name is Thành Phát.", "I really like website design 🌭"];
    ...
    public $SocialNetworks = [
        "facebook" => "https://ww.facebook.com/Thanh.Phat.203?locale=vi_VN", // Thay link facebook
...
class ThanhPhatLoveDays implements ThanhPhatConfigInterface {
    public $ConfigLove = [
        "avatar_male" => "https://i.ibb.co/SQZpJDG/098e06ef-5f72-4029-bd50-1153101bf1b9.jpg", // Thay đường dẫn tới thư mục chứa ảnh của bạn hoặc up ảnh lấy link tại img.thanhdieu.com
        "name_male" => "Thành Phát", // Thay tên của bạn
        //========================================================//
        "avatar_female" => "https://i.ibb.co/TgP3YgB/5565e939-8150-48d7-9a16-b0f3e02cd946.jpg", // Thay đường dẫn tới thư mục chứa ảnh bạn gái hoặc up ảnh lấy link tại img.thanhdieu.com
        "name_female" => "Thúy Phương", // Thay tên đối phương
        //========================================================//
        "time_relashiption" => "07/08/2020" //Định dạng ngày tháng năm: DD-MM-YYYY or / or :
        //========================================================//
    ];
    public function CommonMethod() {}
}
